                    ...
                    <form role="form" id="form">
                        <!-- <div class="row"> -->
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input class="form-control" id="password" name="password" maxlength="20"></input>
                                <i class="fas fa-check-circle"></i>
                                <i class="fas fa-exclamation-circle"></i>
                                <small>Error message</small>
                            </div>
                            <div class="form-group col-lg-6">
                                ...
                                <input class="form-control" id="confirme password" name="confirme password" maxlength="20"></input>
                                <i class="fas fa-check-circle"></i>
                                <i class="fas fa-exclamation-circle"></i>
                                <small>Error message</small>
                            </div>
